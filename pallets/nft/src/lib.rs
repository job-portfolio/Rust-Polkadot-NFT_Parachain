...
use super::*;
	...
	impl<T:Config> Pallet<T> {
		...
		pub fn mint_single(origin: OriginFor<T>, data: Vec<u8>, royalty: u8) -> DispatchResult {
		...
		#[pallet::weight(10_000 + T::DbWeight::get().writes(1))]
		pub fn mint_limited(origin: OriginFor<T>, data: Vec<u8>, copies: u16, royalty: u8) -> DispatchResult {
			let caller = ensure_signed(origin)?;
		...
		#[pallet::weight(10_000 + T::DbWeight::get().writes(1))]
		pub fn mint_unlimited(origin: OriginFor<T>, data: Vec<u8>, royalty: u8) -> DispatchResult {
			let caller = ensure_signed(origin)?;
		...
		#[pallet::weight(10_000 + T::DbWeight::get().writes(1))]
		pub fn mint_stack(origin: OriginFor<T>, data: Vec<u8>, amount: u64, royalty: u8) -> DispatchResult {
			let caller = ensure_signed(origin)?;
		...
		#[pallet::weight(10_000 + T::DbWeight::get().writes(1))]
		pub fn burn(origin: OriginFor<T>, id: T::Hash, index: u16) -> DispatchResult {
			let caller = ensure_signed(origin)?;
		...
		#[pallet::weight(10_000 + T::DbWeight::get().writes(1))]
		pub fn transfer(origin: OriginFor<T>, to: T::AccountId, id: T::Hash, index: u16) -> DispatchResult {
			let caller = ensure_signed(origin)?;
		...
		#[pallet::weight(10_000 + T::DbWeight::get().writes(1))]
		pub fn sell(origin: OriginFor<T>, id: T::Hash, index: u16, price: BalanceOf<T>, sample: Vec<u8>, quantity: u64, day: u8) -> DispatchResult {
		...
		#[pallet::weight(10_000 + T::DbWeight::get().writes(1))]
		pub fn buy(origin: OriginFor<T>, seller: T::AccountId, id: T::Hash, index: u16, price: BalanceOf<T>, quantity: u64) -> DispatchResult {
